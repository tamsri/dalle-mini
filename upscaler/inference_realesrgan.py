...
def main():
    ...
    parser.add_argument('-o', '--output', type=str, default='data/upscaled', help='Output folder')
    ...
    have_a_job = False
    while True:
        # check is files exists in 'data/generated' folder
        ...
        if len(files) > 0:
            ...
            logger.info("Testing " + str(imgname))
